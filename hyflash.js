...
var obey = ["trance deeper",
            ...
            "your trigger is 'magic sleep now'"
           ];
...
var scrambledPrograms = ["rollercoaster3_agree", "rollercoaster_notwitch", "rollercoaster", "rollercoaster_unsafe", "nicer__rollercoaster", "twitchy", "persuade", "slutty", "work", "controlprogram", "controlprogram_puppet"];

// These are relaxing programs that should not have twitchy commands inserted
var noTwitchy = ["forestprog", "relaxprog", "wakeupunstuck", "wakeupslow"];

// These are awakeners that go at the end even in a randomized sequence
var awakeners = ["wakeupunstuck", "wakeupslow"];
...
function pushProgram(p, refs, sprinkles_refs, pName){
    ...
    for(let j=0;j<p.length;j++){
        ...
        if(sprinkles && sprinkles.length > 0 && !noTwitchyP && Math.random() < sprinkleProb)
        {
            ...
            if(endsInPeriod && doesntEndInEllipses || nextLineBeginsUppercase){
...
function preparePrograms(){
    ...
    for(let i=0;i<numProgs;i++){
        ...
        if(inArray(scrambledPrograms,pName)){
            let noTwitchyP = inArray(noTwitchy, pName);
            progression.push("magic sleep now");
            var j2 = Math.floor(Math.random() * 40)+30
            if (p3 == persuade || p3 == twitchy)
                j2 = Math.floor(Math.random() * 20)+15
            for(let j=0;j<j2;j++){
                let index=Math.floor(Math.random() * p3.length);
            ...
            pushProgram(p3, refs, sprinkles_refs, pName);
        }
    }

    for(let i=0;i<programs_awaken.length;i++){
        pushProgram(programs_awaken[i], refs, sprinkles_refs, programs_awaken_names[i]);
    }
    ...
    if (stripWakes)
    {
        for (let i=0;i<progression.length;i++){
            if ((progression[i].indexOf("wake up") == -1 && progression[i].length > 0) || progression.length - i < 4 || progression[i].length > 10)
                prog2.push(progression[i]);
        }
        progression = prog2;
    }
    for(let i=0; i < progression.length; i++)
        progression[i] = progression[i].replace(/magic sleep now/g,trigger);
...
// presets
/*var puppet_presets = `
{"presets":"puppet_presets","textdump":false,"spreed":false,"speedup":"1","show_center_text":true,"programs":"puppet puppetstrings rollercoaster forgetresistance work acceptpleasure amnesia wakeupunstuck","pain":false,"unsafe":false,"wake":false,"randomize":true,"numProgs":"5","triggerprog":false,"sprinkles_list":"whisper_sprinkles puppet_sprinkles persuade_sprinkles mean_sprinkles","sprinkleProb":"0.6","voice":"female2","Spiral.gif":true,"spiral7_horizontal.gif":false,"spiral8.gif":false,"spiral10.gif":false,"spiral11.gif":true,"spiral12.gif":true,"spiral17.gif":false,"spiral18.gif":false,"spiral19.gif":false,"spiral20.gif":false,"spiral21.gif":false,"spiral9.gif":true,"spiral13.gif":false,"spiral14.gif":false,"spiral15.gif":false,"spiral16.gif":true,"only_spiral":false,"badcommands":"","backgroundSuggestions":"obeyself","flashrate":"200","binaurals":true,"binGain":"0.15","binLeft":"200","binRight":"205","trigger":"magic sleep now","triggerText":"","randExtras":"randExtras"}
`;*/

var beginner_presets = `
{"presets":"beginner_presets","textdump":false,"spreed":false,"speedup":"1","show_center_text":true,"programs":"forestprog relaxprog triggerprog forgetresistance obeyprog amnesia acceptpleasure","alt_programs":"nicer","wake":false,"randomize":false,"numProgs":"5","triggerprog":false,"sprinkles_list":"","sprinkleProb":"0","voice":"female2","Spiral.gif":true,"spiral7_horizontal.gif":false,"spiral8.gif":false,"spiral10.gif":false,"spiral11.gif":true,"spiral12.gif":true,"spiral17.gif":false,"spiral18.gif":false,"spiral19.gif":false,"spiral20.gif":false,"spiral21.gif":false,"spiral9.gif":true,"spiral13.gif":false,"spiral14.gif":false,"spiral15.gif":false,"spiral16.gif":true,"only_spiral":false,"badcommands":"","backgroundSuggestions":"none","flashrate":"200","binaurals":true,"binGain":"0.15","binLeft":"200","binRight":"205","trigger":"magic sleep now","triggerText":"","randExtras":"randExtras"}
`;

var notwitch_presets = `
{"presets":"notwitch_presets","textdump":false,"spreed":false,"speedup":"1","show_center_text":true,"programs":"obeyprog amnesia acceptpleasure forgetresistance rollercoaster","pain":false,"unsafe":false,"wake":false,"randomize":true,"numProgs":"5","triggerprog":false,"sprinkles_list":"whisper_sprinkles persuade_sprinkles","sprinkleProb":"0.4","voice":"female2","Spiral.gif":true,"spiral7_horizontal.gif":false,"spiral8.gif":false,"spiral10.gif":false,"spiral11.gif":true,"spiral12.gif":true,"spiral17.gif":false,"spiral18.gif":false,"spiral19.gif":false,"spiral20.gif":false,"spiral21.gif":false,"spiral9.gif":true,"spiral13.gif":false,"spiral14.gif":false,"spiral15.gif":false,"spiral16.gif":true,"only_spiral":false,"badcommands":"","backgroundSuggestions":"obeyself","flashrate":"200","binaurals":true,"binGain":"0.15","binLeft":"200","binRight":"205","trigger":"magic sleep now","triggerText":"","randExtras":"randExtras"}
`;

var slut_presets = `
{"presets":"slut_presets","textdump":false,"spreed":false,"speedup":"1","show_center_text":true,"programs":"slutty","pain":false,"unsafe":false,"wake":false,"randomize":false,"numProgs":"5","triggerprog":false,"sprinkles_list":"","sprinkleProb":"0","voice":"female2","Spiral.gif":true,"spiral7_horizontal.gif":false,"spiral8.gif":false,"spiral10.gif":false,"spiral11.gif":true,"spiral12.gif":true,"spiral17.gif":false,"spiral18.gif":false,"spiral19.gif":false,"spiral20.gif":false,"spiral21.gif":false,"spiral9.gif":true,"spiral13.gif":false,"spiral14.gif":false,"spiral15.gif":false,"spiral16.gif":true,"only_spiral":false,"badcommands":"","backgroundSuggestions":"obeyself","flashrate":"200","binaurals":true,"binGain":"0.15","binLeft":"200","binRight":"205","trigger":"magic sleep now","triggerText":"","randExtras":"randExtras"}
`;
...
var control_presets = `
{"presets":"control_presets","textdump":false,"spreed":false,"speedup":"1","show_center_text":true,"programs":"controlprogram controlprogram controlprogram","alt_programs":"nicer","wake":false,"randomize":true,"numProgs":"5","triggerprog":false,"sprinkles_list":"","sprinkleProb":"0.4","voice":"female2","Spiral.gif":true,"spiral7_horizontal.gif":false,"spiral8.gif":false,"spiral10.gif":false,"spiral11.gif":true,"spiral12.gif":true,"spiral17.gif":false,"spiral18.gif":false,"spiral19.gif":false,"spiral20.gif":false,"spiral21.gif":false,"spiral9.gif":true,"spiral13.gif":false,"spiral14.gif":false,"spiral15.gif":false,"spiral16.gif":true,"only_spiral":false,"badcommands":"","backgroundSuggestions":"encourageControl","flashrate":"200","binaurals":true,"binGain":"0.15","binLeft":"200","binRight":"205","trigger":"magic sleep now","triggerText":"","randExtras":"randExtras"}
`;

var puppet_presets = `
{"presets":"puppet_presets","textdump":false,"spreed":false,"speedup":"1","show_center_text":true,"programs":"puppet puppetstrings rollercoaster forgetresistance work acceptpleasure amnesia wakeupunstuck controlprogram_puppet","alt_programs":"nicer","wake":false,"randomize":true,"numProgs":"5","triggerprog":false,"sprinkles_list":"whisper_sprinkles puppet_sprinkles persuade_sprinkles mean_sprinkles","sprinkleProb":"0.6","voice":"female2","Spiral.gif":true,"spiral7_horizontal.gif":false,"spiral8.gif":false,"spiral10.gif":false,"spiral11.gif":true,"spiral12.gif":true,"spiral17.gif":false,"spiral18.gif":false,"spiral19.gif":false,"spiral20.gif":false,"spiral21.gif":false,"spiral9.gif":true,"spiral13.gif":false,"spiral14.gif":false,"spiral15.gif":false,"spiral16.gif":true,"only_spiral":false,"badcommands":"","backgroundSuggestions":"encourage","flashrate":"200","binaurals":true,"binGain":"0.15","binLeft":"200","binRight":"205","trigger":"magic sleep now","triggerText":"","randExtras":"randExtras"}
`;
...
function initializeFromForm(){
    ...
    x = f["triggerprog"].checked;
    if (x){
        if (triggerprog.length>0)
            progression = triggerprog.concat([]);
        else if (triggerprog_unsafe.length > 0)
            progression = triggerprog_unsafe.concat([]);
        else if (triggerprog_mistress.length > 0)
            progression = triggerprog_mistress.concat([]);
        else
            progression = [];
    }
    else
...
function doTextwall(suggestions){
    ...
    for(i = 0; i < 100; i++){
        ...
        wall.push(suggestions[snum].replace(/magic sleep now/g, trigger) + " &nbsp;");
    }
...
function doProgression(){
    ...
    if (progTime < new Date().getTime()){
        ...
        if (progIndex < progression.length){
            ...
            if(speak && window.Speak)
                window.Speak(progSnippet);
            else if (speak){
                //().\\\"'?
                ...
                if (filename.length > 30)
                    filename = filename.substr(0,30) + fnv_hash(filename);
                filename = "speech_" + voice + "_mp3s/" + filename + ".mp3";
                //alert(filename);
